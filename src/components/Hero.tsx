    ...
    <section className="relative flex flex-col items-center justify-center min-h-screen px-6 pt-20 overflow-hidden">
      <div className="z-10 max-w-4xl text-center">
        ...
        <motion.h1
          ...
          className="mb-6 text-3xl font-bold tracking-tight text-white md:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-white via-accent to-secondary"
        >
          Aniruddha Hossen
        </motion.h1>
        ...
        <motion.p
          ...
          className="max-w-2xl mx-auto mb-10 text-sm leading-relaxed text-white/60 md:text-base"
        >
